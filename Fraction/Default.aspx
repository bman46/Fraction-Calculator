...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:RegularExpressionValidator ForeColor="Red" ID="RegularExpressionValidator2" runat="server" ErrorMessage="Numbers and / only" ControlToValidate="Fraction1" ValidationExpression="\d*\s*\d+(\.\d+)?/\d+(\.\d+)?" />
    ...
    <asp:RegularExpressionValidator ForeColor="Red" ID="RegularExpressionValidator1" runat="server" ErrorMessage="Numbers and / only" ControlToValidate="Fraction2" ValidationExpression="\d*\s*\d+(\.\d+)?/\d+(\.\d+)?" />
    ...
    <asp:Button ID="Root" OnClick="Root_Click" runat="server" Text="Root" class="btn btn-info" />
